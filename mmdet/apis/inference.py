...
# colors=['red', 'lightsalmon', 'darkorange', 'orange', 'gold', 'yellow','greenyellow','lime','aquamarine','lightblue','dodgerblue',
#         'royolblue','blue','hotpink','lightpink']

colors=[(244,67,54), (233,30,99), (156,39,176),(103,58,183),    #PL BD BR GTF 
        (63,81,181), (33,150,243),(0,188,212),             #SV LV SH 
        (0,150,136), (76,175,80), (139,195,74),             #TC BC ST 
        (205,220,57), (255,235,59), (255,152,0),              #sbf RA HA 
        (255,87,34), (121,85,72) ] #SP HC
...
def draw_poly_detections(img, detections, class_names, scale, threshold=0.2):
    ...
    for j, name in enumerate(class_names):
        color = colors[j]#(random.randint(0, 256), random.randint(0, 256), random.randint(0, 256))

...
from mmdet.core import merge_rotate_aug_bboxes, merge_rotate_aug_proposals,dbbox2roi
import copy
...
class BBoxTestMixin(object):
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        for x, img_meta in zip(feats, img_metas):
            ...
            aug_bboxes.append(det_rbboxes)
            aug_scores.append(det_labels)
        # after merging, bboxes will be rescaled to the original image size
        # merged_bboxes, merged_scores = merge_aug_bboxes(
        #     aug_bboxes, aug_scores, img_metas, rcnn_test_cfg)
        # print('merged_scores',len(merged_scores))
        # print(merged_scores[0].shape)

...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',type=str,default='../configs/CGC/0803_faster_rcnn_RoITrans_r50_fpn_1x_dota_consis_multiscale.py')
...
if __name__ == '__main__':
    ...
    pkl_file = 'result.pkl'#os.path.join('work_dirs', config_name, 'results.pkl')

...
if __name__ == '__main__':
    ...
    # split = splitbase(r'/home//project/dota2/test-c1',
    #                   r'/home//project/dota2/test-c1-1024',
    #                   gap=512,
    #                   subsize=1024,
    #                   num_process=16)
    # split.splitdata(1)
    ...
    split_test_single = splitbase(r'/home//project/dota2/test-dev',
                                  r'/home//workfs/dota2_v2/split-1024-v2/test-dev1024',
                                  gap=512,
                                  subsize=1024,
                                  num_process=16)
    split_test_single.splitdata(1)

    split_test_ms = splitbase(r'/home//project/dota2/test-dev',
                                  r'/home//workfs/dota2_v2/split-1024-v2/test-dev1024_ms',
                                  gap=512,
                                  subsize=1024,
                                  num_process=16)

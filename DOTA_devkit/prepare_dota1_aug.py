...
def parse_args():
    ...
    parser.add_argument('--srcpath', default=r'/home/sdb/data/remoteSensingData/DOTA/DOTA')
    parser.add_argument('--dstpath', default=r'/home/sdb/data/remoteSensingData/DOTA/dota1-split-1024',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    # DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024_single'), os.path.join(dstpath, 'trainval1024_single', 'DOTA_trainval1024_single.json'), wordname_15, difficult='2')

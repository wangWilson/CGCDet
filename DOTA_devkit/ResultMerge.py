...
def mergebypoly(srcpath, dstpath):
    ...
    dstpath: result files after merge and nms
    """
    # srcpath = r'/home//evaluation_task1/result/faster-rcnn-59/comp4_test_results'
    # dstpath = r'/home//evaluation_task1/result/faster-rcnn-59/testtime'
    mergebase(srcpath,
              dstpath,
              py_cpu_nms_poly)
    # mergebase(srcpath,
...
if __name__ == '__main__':
    ...
    start = time.clock()
    # mergebypoly(r'/home//data/ODAI/ODAI_submmit/baseline/task1_results',
    #             r'/home//data/ODAI/ODAI_submmit/baseline/task1_merge2')
    # mergebypoly(r'/home//Documents/Research/experiments/rotateanchorrotateregion/40_angle_agnostic',
    #             r'/home//Documents/Research/experiments/rotateanchorrotateregion/40_angle_agnostic_0.1_nms')
    mergebypoly(r'/home//Documents/Research/experiments/Deform_FPN_Naive_poly/Task1_results_epoch12',
                r'/home//Documents/Research/experiments/Deform_FPN_Naive_poly/Task_results_epoch12_0.1_nms')
    # mergebyrec(r'/home//Documents/Research/experiments/Deform_FPN_HBB/Task2_results',
    #            r'/home//Documents/Research/experiments/Deform_FPN_HBB/Task2_results_0.3_nms')
